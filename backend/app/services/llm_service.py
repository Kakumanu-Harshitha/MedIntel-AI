...
from app.models.schemas import RiskAssessment, Explanation, Recommendations, HealthReport
from app.database import mongo_memory
from app.rag.rag_service import rag_service
from app.database.structured_memory import structured_memory
from app.api.rag_router import rag_router, QueryIntent, DatasetType
...
async def run_clinical_analysis(profile: dict, history: list[dict], inputs: dict, request: Request | None = None) -> str:
    ...
    if not is_report_analysis and not is_image_analysis and user_text.strip():
        try:
            from app.ai_pipeline.clinical_memory import session_repo, ClinicalState
